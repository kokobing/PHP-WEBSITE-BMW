...
<h3><?=$onenews[title]?></h3>
<p><?=$onenews[content]?></p>
<?php if($ndir==2){?><div id="backbox"><a href="/<?=$onenews[url]?>"> 活动报名 </a></div><?php }?>
<div id="backbox"><a href="javascript:void(0)"  onClick=' $("html,body").animate( {scrollTop:0},"slow",function() {return false;});' class="backtop"> 返回顶部 </a></div>
</div>
</div>
<!-- content end-->
