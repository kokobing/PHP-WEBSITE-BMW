...
<div id="abouttop"><div id="abouttit"><?=$onenewsdir[name];?></div></div>
<div class="newslistbox">
			<ul data-role="listview" data-inset="true" id="type-newslist">
            <?php for($i=0;$i<sizeof($arrnews);$i++){?>
				<li><a href="/events/eventsview.php/<?=$ndir?>/<?=$arrnews[$i][id_newsinfo]?>/.html"><?=$arrnews[$i][title]?></a></li>
            <?php }?>
            </ul>
