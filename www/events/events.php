<?php
require "../inc/cn_events_core.php";
?>
<!DOCTYPE HTML>
<html>
<head>
...
?>
    <div data-role="collapsible" data-theme="c" data-content-theme="d" data-inset="false" data-collapsed="false">
        <h2><?=$getnewsdir2[$i][name]?></h2>
        <ul data-role="listview" data-theme="c" class="newsview">
        <?php for($j=0;$j<sizeof($arrnews);$j++){?>
		<li><a href="/events/eventsview.php/<?=$ndir?>/<?=$arrnews[$j][id]?>/.html"><?=$arrnews[$j][title]?></a></li>
        <?php }?>
        <li style="font-weight:normal; font-size:10px;"><a href="/events/eventslist.php/<?=$ndir?>/.html">查看更多信息</a></li>
        </ul>
    </div>
<?php }?>
