...
if(isset($action) && $action=='01' && $onuserperm_addprem=='1'){
	...
	$strSQL="INSERT INTO productinfo(title,content,id_proddir,indate,intro,tag,videourl) 
...
if(isset($action) && substr($action,0,2)=="04" && $onuserperm_editprem=='1'){
    ...
    $strSQL="UPDATE productinfo SET title='$newstitle',content='$newscontent',id_proddir='$select2',modate=now(),intro='$newsintro',tag='$newstag',videourl='$videourl' where id_prodinfo=$oneproductinfoid";
          ...
          <td align="center"><table width="93%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <table width="100%" border="0" cellpadding="4" cellspacing="0" class="txt">
                  ...
                  <tr bgcolor="#FFFFFF">
                    <td valign="top" bgcolor="#FFFFFF">视频地址</td>
                    <td bgcolor="#FFFFFF">
                    <input name="videourl" type="text" class="input_01" id="videourl" style="width:500px" value="<?php echo $oneproductinfo[videourl];?>" />
                    </tr>
                  <tr bgcolor="#FFFFFF">
