...
//交换位置
  ...
  $str=" and  newsdir.id_newsdir!='4'  and  newsdir.id_newsdir!='20'  and  newsdir.id_newsdir!='21' ";
  }
            ...
            <tr>
              ...
              <table width="100%" border="0" cellspacing="5" cellpadding="3">
                  <tr>
                    ...
                    <? if($arrnewsinfos[$i][id_newsdir]!=4 || $arrnewsinfos[$i][id_newsdir]!=20){?>
                    <a href="javascript:void(0)" ><img src=getqrcode.php?nid=<?=$arrnewsinfos[$i][id_newsinfo];?>&ndir2=<?=$arrnewsinfos[$i][id_newsdir];?>&lang=<?=$arrnewsinfos[$i][lang];?>&ecc=Q&size=1   onclick="$.wholepop.dialogClass ='style_1';popmessage('<img src=getqrcode.php?nid=<?=$arrnewsinfos[$i][id_newsinfo];?>&ndir2=<?=$arrnewsinfos[$i][id_newsdir];?>&lang=<?=$arrnewsinfos[$i][lang];?>&ecc=Q&size=4  />','<?php echo cutstr($arrnewsinfos[$i][title],30,1);?>')"   /></a>
                    <? }?>
...
<div id="lineout" style="position:relative">
 ...
 <? if($onenewsinfo[id_newsdir]!=4  || $arrnewsinfos[$i][id_newsdir]!=20){?>
