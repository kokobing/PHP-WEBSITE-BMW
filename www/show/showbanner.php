<div class="section car_wrapper"  >
            ...
            <?php 
			$showbanner=getproductallpic($pid);
			for($i=1;$i<sizeof($showbanner);$i++){?>
            <li>
               <a href="/"><img src="/upload/product/<?=$showbanner[$i][pic]?>" width="100%" alt="" /></a>
            </li>		
            <?php }?>
...
<style>
.pager { position:absolute;right:0px;bottom:20px;width: 100%;text-align: center;color:#fff;}
