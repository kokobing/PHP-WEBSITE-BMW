...
?>
    <div data-role="collapsible" data-theme="c" data-content-theme="d" data-inset="false" data-collapsed="false">
		...
		<li><a href="/news/newsview.php/<?=$ndir?>/<?=$arrnews[$j][id]?>/.html"><?=$arrnews[$j][title]?></a></li>
        <?php }?>
        <li style="font-weight:normal; font-size:10px;"><a href="/news/newslist.php/<?=$ndir?>/.html">查看更多信息</a></li>
        </ul>
    </div>
<?php }?>
