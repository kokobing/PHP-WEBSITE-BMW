...
<div id="abouttop"><div id="abouttit">PRODUCTS</div></div>
<div id="productbox">
<div id="productmenu">
<?php for($i=0;$i<sizeof($getproductdir2);$i++){?>
<div class="productbox1"><a href="/en/product/productlist.php/<?=$getproductdir2[$i][id]?>/.html"><?=$getproductdir2[$i][name]?></a></div>
...
$arrproduct=$objDB->GetRows();
			...
			<li><a href="/en/product/productpage.php/<?=$arrproduct[$j][id_proddir]?>/<?=$arrproduct[$j][pid]?>/.html">
