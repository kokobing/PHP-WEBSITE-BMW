<?php
require "../../inc/en_productpage_core.php";
?>
<!DOCTYPE HTML>
<html>
<head>
...
<div id="abouttop"><div id="abouttit"><a href="/en/product/productlist.php/<?=$pdir?>/.html"><?=$pdirname[name]?></a></div></div>
<div id="productviewbox">
<div id="productviewbox1"><?=$oneproduct[title]?></div>
<div id="productviewbox3">
<p><?=$oneproduct[content]?></p>
<div id="backbox"><a href="javascript:void(0)"  onClick=' $("html,body").animate( {scrollTop:0},"slow",function() {return false;});'> Back To Top </a></div>
</div>
</div>
</div>
<!-- content end-->
